...
import edu.anagen.cs.ssuet.ocr.activities.OCRResultActivity;
import edu.anagen.cs.ssuet.ocr.camera.CameraManager;
import edu.anagen.cs.ssuet.ocr.camera.ShutterButton;
import edu.anagen.cs.ssuet.ocr.language.LanguageCodeHelper;
import edu.anagen.cs.ssuet.ocr.language.TranslateAsyncTask;
  ...
  boolean handleOcrDecode(OcrResult ocrResult) {
    ...
    if (ocrResult.getText() == null || ocrResult.getText().equals("")) {
     ...
     /* shutterButton.setVisibility(View.GONE);
      ...
      String ocrText = ocrResult.getText().toString();
      Intent intent = new Intent(CaptureActivity.this, OCRResultActivity.class);
